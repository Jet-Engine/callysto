...
///
/// Since `Statistics` doesn't implement Clone in upstream.
/// We have done this dirty hack to Clone statistics for placing a callback for it.
/// Reimplementation of: <https://docs.rs/rdkafka/latest/rdkafka/statistics/struct.Statistics.html>

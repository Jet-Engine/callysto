    ...
    State: Clone + Send + Sync + 'static
{
    ...
    async fn on_rebalance(&self, assigned: Vec<CTP>, revoked: Vec<CTP>, newly_assigned: Vec<CTP>, generation_id: usize) -> Result<()>;

    async fn on_recovery_completed(&self, active_tps: Vec<CTP>, standby_tps: Vec<CTP>) -> Result<()>;
}